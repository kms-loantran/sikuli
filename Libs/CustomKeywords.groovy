...
def static "katalon.WindowsKeywords.startApplicationWithTitle"(
    	String application	
     , 	String title	) {
    (new katalon.WindowsKeywords()).startApplicationWithTitle(
        	application
         , 	title)
}


def static "katalon.WindowsKeywords.switchToWindowTitle"(
    	String title	) {
    (new katalon.WindowsKeywords()).switchToWindowTitle(
        	title)
}


def static "katalon.WindowsKeywords.startApplicationWithTitlePattern"(
    	String application	
     , 	String titleRegex	) {
    (new katalon.WindowsKeywords()).startApplicationWithTitlePattern(
        	application
         , 	titleRegex)
}


def static "katalon.WindowsKeywords.switchToWindowTitlePattern"(
    	String titleRegex	) {
    (new katalon.WindowsKeywords()).switchToWindowTitlePattern(
        	titleRegex)
}


def static "katalon.WindowsKeywords.startApplicationWithTitleContains"(
    	String application	
     , 	String aPartOfTitle	) {
    (new katalon.WindowsKeywords()).startApplicationWithTitleContains(
        	application
         , 	aPartOfTitle)
}


def static "katalon.WindowsKeywords.switchToWindowWithTitleContains"(
    	String aPartOfTitle	) {
    (new katalon.WindowsKeywords()).switchToWindowWithTitleContains(
        	aPartOfTitle)
}
